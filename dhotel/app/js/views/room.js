...
class RoomView extends Component {
	...
	fetchCanCheckIn() {
		return Bookings.methods.canCheckIn().call({ from: this.props.accounts[0] })
	...
	fetchCanCheckOut() {
		return Bookings.methods.canCheckOut().call({ from: this.props.accounts[0] })
	...
	onCheckIn() {
		...
		return Bookings.methods.deposit().call().then(value => {
			return Bookings.methods.checkIn()
	...
	onCheckOut() {
		...
		return Bookings.methods.checkOut()
